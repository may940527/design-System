...
const preset: Config = {
  ...
  theme: {
    ...
    borderRadius: {
      ...
      xs:      "4px",    // --radius-xs   0.25rem
      sm:      "6px",    // --radius-sm   0.375rem
      md:      "8px",    // --radius-md   0.5rem
      DEFAULT: "8px",
      lg:      "12px",   // --radius-lg   0.75rem
      xl:      "20px",   // --radius-xl   1.25rem
      "2xl":   "24px",   // --radius-2xl  1.5rem
      full:    "50%",    // --radius-circle
    },

    // ── Breakpoints (VEGA UI 스펙) ───────────────────────────
    screens: {
      xs:    "320px",   // Small smartphone
      sm:    "480px",   // Large smartphones, small tablets
      md:    "768px",   // Tablets
      lg:    "1024px",  // Large tablets, small laptop
      xl:    "1440px",  // Laptop, small desktop
      "2xl": "1768px",  // Larger desktops and external monitors
    },
    ...
    extend: {
      ...
      colors: {
        ...
        "ac-gray": {
          10: "#FBFBFB",
          20: "#F7F7F7",  // background gray
          30: "#ECECEC",
          40: "#D9D9D9",  // border solid
          50: "#A8A8A8",  // normal
          60: "#828282",
          70: "#5F5F5F",
          80: "#555555",  // font gray
